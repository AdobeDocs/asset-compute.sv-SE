...
Användarna arbetar i en mycket konkurrensutsatt miljö och strävar efter att skapa digitala upplevelser som skiljer dem från deras konkurrenter. Därför är det viktigt att Adobe, när de levererar avancerade nya verktyg, kompletterar dessa verktyg med korrekt och tydlig dokumentation. Dokumentation som gör det möjligt för kunderna att använda sin investering direkt och maximera avkastningen.
...
Alla bidrag till dokumentationen, antingen i form av en ansökan om att få lämna in en ansökan eller i form av ett problem, bör uppfylla Adobe standarder för bidrag och dokumentation.
...
Alla idéer du kan behöva förbättra dokumentationen är välkomna som bidrag. Kommentarer, utgåvor och pull-begäranden är dock endast avsedda för *bidrag*. De ska inte besvara dina frågor om hur du använder produkten, implementerar projekt eller löser tekniska problem.

Alla frågor om användningen eller tekniska fel som du kan ha rapporterats via den normala supportprocessen via [[!DNL Experience Manager] kundsupportportalen](https://experienceleague.adobe.com/sv?support-solution=Experience+Manager#home) eller i [[!DNL Experience Manager] communityn](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/ct-p/adobe-experience-manager-community).

***Dokumentationsbidragen ersätter inte Adobe kundtjänst*** och eventuella bidrag som söker svar på supportrelaterade frågor avvisas.
...
Om du följer dessa riktlinjer blir det enklare att granska ditt bidrag och det går därför snabbare att integrera det i Adobe dokumentation.
...
[Microsoft Manual of Style](https://learn.microsoft.com/en-us/style-guide/welcome/) är en kostnadsfri handbok för dokumentationsformat som fokuserar på programvarudokumentation.
